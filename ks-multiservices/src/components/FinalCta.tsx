      ...
      <div className="container-page grid gap-12 lg:grid-cols-2 lg:items-center lg:gap-20">
        <div>
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-3 rounded-full bg-[color:var(--color-brass)] px-8 py-5 text-lg font-semibold text-ink shadow-[0_20px_45px_-18px_rgba(200,154,63,0.6)] transition hover:bg-[color:var(--color-brass-strong)]"
          >
